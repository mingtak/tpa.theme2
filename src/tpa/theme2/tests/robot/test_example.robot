...
#
#  $ bin/test -s tpa.theme2 -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src tpa.theme2.testing.TPA_THEME2_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/tpa/theme2/tests/robot/test_example.robot
#
